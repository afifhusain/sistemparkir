        ...
        <div class="footer-copyright">
          <div class="container">
            <span>Copyright ©
              ...
              </script> <a class="grey-text text-lighten-2" href="http://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" target="_blank"></a></span>
            <span class="right hide-on-small-only">  <a class="grey-text text-lighten-2" href="https://pixinvent.com/"></a></span>
          </div>
        </div>
    </footer>
    <!-- END FOOTER -->
