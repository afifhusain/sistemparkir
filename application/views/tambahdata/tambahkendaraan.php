...
<div class="col s12">
    ...
    <form action="" method="post">
        ...
        <div class="input-field">
          ...
          <input id="no_plat" type="email"  name="no_plat">
         ...
         <div class="input-field">
          ...
          <input id="jenis_mobil" name="jenis_mobil" type="password" >
       ...
       <!--  <?= form_error('pas1', ' <small  class="text-danger pl-3">', '</small>'); ?> -->
        ...
        <div class="input-field">
          ...
          <input id="merk_mobil" name="merk_mobil" type="password" >
          <label for="icon_telephone">Merk Mobil</label>
        </div>  

        <div class="input-field">
          <i class="material-icons prefix">color_lens</i>
          <input id="warna_mobil" name="warna_mobil" type="password" >
